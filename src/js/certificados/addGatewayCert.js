App = {
  ...
  render: function() {
    ...
    certReg.replaceWith("<form id='myForm'>" +
            "<br><label for='idG'>idG (uint16):</label><br>" +
            "<input type='text' id='idG' required><br>" +
            "<label for='userAddress'>User Address (address):</label><br>" +
  ...
  sensorCertRegistration: function(){
    ...
    App.contracts.Protocol.deployed().then(function(instance) {
      ...
      instance.gatewayCertificateCreation(idG, userAddress, { from: App.account });
