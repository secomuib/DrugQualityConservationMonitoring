App = {
  ...
  render: function() {
    ...
    sensorReg.replaceWith("<form id='myForm'><br><label for='idG'>Gateway ID (uint16):</label><br><input type='text' id='idG' required><br><input type='button' id='submitButton' value='Obtener información' onclick='App.getCertData()'></form>");
  ...
  if (confirmation) {
    App.contracts.Protocol.deployed()
      .then(function(instance) {
        ...
        return instance.revokeGatewayCertificate(idG, { from: App.account });
      })
